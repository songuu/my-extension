...
const website = {
  ...
  init: () => {
    ...
    const originObject = {
      context2DPrototype: (window as any).document.createElement("canvas").getContext("2d")
        .__proto__,
    };
    ...
    const render = () => {
      ...
      const closeButton = document.querySelector("#copy-template-html #template-close") as any;
      const close = () => {
